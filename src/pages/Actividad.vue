      ...
      >
        ...
        <div class="col-12 col-md-8 col-lg-9">
          <div class="titulo-segundo">
            <h2>
              Prueba de conocimientos sobre cableado estructurado: diseño e
              implementación de redes.
            </h2>
          </div>
          <p class="mb-4">
            Evaluar el conocimiento adquirido sobre sobre cableado estructurado:
            diseño e implementación de redes. Esto se trabaja a partir de un
